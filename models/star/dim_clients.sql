...
first_checkout_completed as (
    select * from checkouts_completed
    where client_purchase_sequence = 1
),
...
final as (
    SELECT
        ...
        first_checkout_completed.session_number as first_checkout_completed_session_number
